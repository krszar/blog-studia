...
{   
    ...
    $zapytanie = "insert into amerykas(tytul, tekst, plik) values('$tyt','$art','$plik')";
...
if (isset($_POST["update"]))
{
    ...
    $zapytanie = "update amerykas set tytul='$tyt', tekst='$art' where id=$id";
    $wynik=mysqli_query($conn, $zapytanie);
    //echo "<br>";
    if($wynik)
    {
...
if (isset($_POST["delete"]))
{
    ...
    $zapytanie = "delete from amerykas where id=$id";
    $wynik=mysqli_query($conn, $zapytanie);
    //echo "<br>";
    if($wynik)
    {
...
//  echo "";
  ...
  {
      echo "<div class='kontener'><form method='post' action='amerykasa.php'><input type='text' name='title' value='".$x['tytul']."'> <input name='id' type='hidden' value='".$x['id']."' /><div class='area'><textarea rows='10' cols='200' name='art'>".$x['tekst']."</textarea></div>
...
?>
<div class="kontener">
<form method='post' action='amerykasa.php'  enctype='multipart/form-data'><input type="text" placeholder="Tytuł artykułu" name="title"><div class="area"><textarea rows='10' cols='200' name='art' required></textarea></div>
